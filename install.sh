...
echo "    /ui build        Build UI with all constraints"
echo "    /ui review       Audit a file for violations"
echo "    /ui fix          Apply safe automatic fixes"
echo "    /ui score        Get a quality score"
echo ""
